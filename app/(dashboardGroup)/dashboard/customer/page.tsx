...
const CustomerDashboardPage = () => {
    ...
    if (isError) {
        return (
            <div className="max-w-6xl mx-auto px-4 py-20 text-center text-red-500 dark:text-red-400">
        ...
        <div className="max-w-6xl mx-auto px-4 py-10">
            ...
            {!bookings || bookings.length === 0 ? (
                <div className="text-center py-20 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl">
                    <p className="text-slate-400 dark:text-slate-500 mb-4">You have no bookings yet.</p>
                    <Link
                        href="/services"
                        ...
                        >
                            ...
                            <div className="flex gap-2">
                                ...
                                {(booking.status === 'REQUESTED' || booking.status === 'ACCEPTED') && (
                                    <button className="border border-red-300 dark:border-red-800 text-red-600 dark:text-red-400 text-sm font-medium px-4 py-2 rounded-lg hover:bg-red-50 dark:hover:bg-red-950 transition-colors">
                                        Cancel
                                    </button>
                                )}
                            </div>
